...
- _Challenge:_ A computer treats "Gabriel Boric" and "Presidente Boric" as two different people. I implemented an entity resolution step to clean and normalize these names so the network reflects reality.
